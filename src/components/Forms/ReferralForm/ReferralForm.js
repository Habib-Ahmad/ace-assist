		...
		<Layout onSubmit={submit} title='Client Referral Form'>
			...
			<div className='font-semibold text-lg'>
				<RegularInputBox
					...
					cb={(e) =>
						setState({ ...state, referral_form: e.target.value })
					}
				/>
				<RegularInputBox
					name='name'
					...
					cb={(e) =>
						setState({
							...state,
							name_of_person_referring: e.target.value
						})
					}
				/>
				<RegularInputBox
					...
					cb={(e) =>
						setState({ ...state, referred_to: e.target.value })
					}
				/>
				<div className='flex'>
					<RegularInputBox
					...
					<RegularInputBox
						...
						cb={(e) =>
							setState({ ...state, signature: e.target.value })
						}
						name='signature'
						label='Signature'
					/>
