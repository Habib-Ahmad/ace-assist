...
function ClientIntakeForm() {
	...
	return (
		<Layout
			onSubmit={submit}
			title='HIV Testing Services: Client Intake Form'
		>
			<div className='newPatient__row'>
				<RegularInputBox
					...
					cb={(e) =>
						setState({ ...state, referred_form: e.target.value })
					}
			...
			<div className='newPatient__row'>
				<RadioButtons
					...
					cb={(e) =>
						setState({ ...state, type_of_session: e.target.value })
					}
				/>
			</div>
			<div className='newPatient__row'>
				<RadioButtons4
					...
					cb={(e) =>
						setState({
							...state,
							index_testing: e.target.value === 'true'
						})
					}
				/>
			</div>
			<div className='newPatient__row'>
				<RadioButtons
					...
					cb={(e) =>
						setState({
							...state,
							index_testing_type: e.target.value
						})
					}
					option2='Sexual'
					option3='Social'
			...
			<RadioButtons3
				...
				cb={(e) =>
					setPostTest({
						...postTest,
						hiv_test_result: e.target.value
					})
				}
			/>
			<br />
			...
			<br />
			<p>
				*If client tests HIV negative, has an HIV Risk Assesment Score
				of 1 and above, or there is evidence of STI syndrome, recommend
			...
			<RadioButtons3
				...
				cb={(e) =>
					setState({
						...state,
						syphilis_test_results: e.target.value
					})
				}
			/>
			<br />
			...
			<RadioButtons3
				...
				cb={(e) =>
					setState({
						...state,
						hepatitis_b_test_results: e.target.value
					})
				}
			/>
			<br />
			...
			<RadioButtons3
				...
				cb={(e) =>
					setState({
						...state,
						hepatitis_c_test_results: e.target.value
					})
				}
			/>
		</Layout>
